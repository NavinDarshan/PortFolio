        ...
        return (
            <div className="bg bg-dark">
                ...
                <div className="forcontact text-center">
                    <a className=" d-flex justify-content-start forbox pr-2 pl-2" href={CV} target="_blank" rel="noopener noreferrer"><i className="fas fa-file-pdf icon foricon pr-2 pl-2"></i><label className=" text-white  text-white pl-2 mt-2">My Resume</label></a><br />
                    ...
                    <a className=" d-flex justify-content-start forbox mt-1 pr-2 pl-2" href="https://linkedin.com/in/navin-darshan" target="blank"><i className="fab fa-linkedin-in icon icon pr-2 pl-2"></i><label className=" text-white  text-white pl-2 mt-2">My Linkedin</label></a><br />
